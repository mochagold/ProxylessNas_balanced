...
class ArchSearchRunManager:
    ...
    def __init__(self, path, yaml_path, super_net, run_config: RunConfig, arch_search_config: ArchSearchConfig):
        # init weight parameters & build weight_optimizer
        self.run_manager = RunManager(path, yaml_path, super_net, run_config, True)
